...
export const Navbar = () => {
  ...
  return (
    <div className={navbarClass}>
      <div className="w-full md:w-[70%] flex justify-between items-center px-6 bg-gradient-to-r from-black via-gray-900 to-black py-2 rounded-b-2xl border-b border-gray-800 shadow-lg backdrop-blur-sm">
